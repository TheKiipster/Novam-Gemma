...
public class BlockBituminousOre extends Block implements IHasModel
{
	public BlockBituminousOre(String name, Material material) 
	{
		super(Material.ROCK);
	...
	ItemInit.ITEMS.add(new ItemBlock(this).setRegistryName(this.getRegistryName()));
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return ItemInit.BITUMINOUS_COAL;
