...
public class BlockImperialQuartzite extends Block implements IHasModel
{
	public BlockImperialQuartzite(String name, Material material) 
	{
		super(Material.ROCK);
	...
	ItemInit.ITEMS.add(new ItemBlock(this).setRegistryName(this.getRegistryName()));
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.IMPERIALQUARTZITE_COBBLESTONE);
