...
public class BlockImperialQuartziteStairs extends BlockStairs implements IHasModel
{
	public BlockImperialQuartziteStairs(String name, IBlockState modelState) 
	{
		super(modelState);
